...
?>
    ...
    <header class="intro-header" style="background-color: <?php echo get_theme_mod( 'cleanblog_header_background_color' ); ?>; background-image: url('<?php echo $headerimg; ?>')">
        <div class="container">
			...
			<?php } else { ?>
                        <h1><?php esc_html_e( 'Tracking successful online startups to uncover gaps in the market', 'cleanblog' ); ?></h1>
			<?php } ?>
                        <hr class="small">
			...
			<?php } else { ?>
                        <span class="subheading"><?php esc_html_e( "You don't know what you've done for me. You've changed my life.", 'cleanblog' ); ?></span>
			<?php } ?>
